...
<html>
    ...
    <body>
        ...
        <form action="gradeController">
            <center>
                <h1>Delete grade</h1>
                Enter subject id: <input type="text" name="subjectId" value="${q.getSubjectId()}">
                <button type="submit" name="de1" value="OK"><div class="spinner"></div>Search</button><br><br>
                Enter student id: <input type="text" name="studentId" value="${q.getStudentId()}">
                <button type="submit" name="de2" value="OK"><div class="spinner"></div>Search</button>
                <br><br><br>
            </center>
            <c:choose>
                        ...
                        <table id="alter">
                            ...
                            <c:forEach items="${list}" var="q">
                                <tr>
                                    ...
                                    <td>
                                        <a href="gradeSubject?stuId=${q.getStudentId()}&subId=${q.getSubjectId()}&modDe=">Delete</a>
                                    </td>
