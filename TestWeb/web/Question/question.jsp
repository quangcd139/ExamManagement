<%-- 
    Document   : question
    Created on : Feb 27, 2023, 12:04:14 PM
    Author     : PC
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="mot">
                ...
                <div class="quang3">
                    <center>
                        <a href="taoDe.jsp">Tao de</a><br><br><br>
                    </center>
                </div>
            ...
            <div class="hai">
                ...
                <form action="questionController" method="post">
                    ...
                    <input class="button-4" type="submit" name="check" value="List all question">
                    <input class="button-4" type="submit" name="check" value="Add question">
                    <br><br>
                    <input class="button-4" type="submit" name="check" value="Update question">
                    <input class="button-4" type="submit" name="check" value="Delete question">
                </form>
            </div>
            ...
            <c:if test="${check<0}">
                <div class="ba">
                    <center>
                        <h3 style="color: red;">Subject ID not found</h3>
                    </center>
                </div>
            </c:if>
